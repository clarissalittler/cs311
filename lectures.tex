...
\includegraphics[width=.9\linewidth]{union1.png}
...
\includegraphics[width=.9\linewidth]{empty.png}
...
\includegraphics[width=.9\linewidth]{union2.png}
...
\includegraphics[width=.9\linewidth]{concat1.png}

and $N$ is something like

\includegraphics[width=.9\linewidth]{concat2.png}
\end{itemize}


then after step one the concatenation looks like

\includegraphics[width=.9\linewidth]{concat3.png}

and after step two will look like 
\includegraphics[width=.9\linewidth]{concat4.png}
...
\includegraphics[width=.9\linewidth]{matching.png}
...
\includegraphics[width=.9\linewidth]{palindrome.png}
...
\includegraphics[width=.9\linewidth]{matchingPrime.png}
...
\includegraphics[width=.9\linewidth]{matchingPrime2.png}
...
\includegraphics[width=.9\linewidth]{zeropowers.png}
...
\includegraphics[width=.9\linewidth]{zeropowersagain.png}
